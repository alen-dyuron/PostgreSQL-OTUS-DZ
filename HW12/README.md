...
Однако одним простым способом этого избавить является зафиксирование цены товара во время продажа, в таблице *sales*, где больше не зависят от текущих цен.
